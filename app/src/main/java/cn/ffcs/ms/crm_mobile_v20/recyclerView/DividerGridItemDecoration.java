package cn.ffcs.ms.crm_mobile_v20.recyclerView;
...
/**
 * @Desc:
 * @Author: Tyras on 2016/6/7 16:10.
 */
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, int itemPosition, RecyclerView parent) {
        ...
        if (isLastRow(parent, itemPosition, rowCount, childCount)) { // 如果是最后一行，则不需要绘制底部分割线
            outRect.set(0, 0, mDivider.getIntrinsicWidth(), 0);
        } else if (isLastColumn(parent, itemPosition, rowCount, childCount)) { // 如果是最后一列，则不需要绘制右侧分割线
