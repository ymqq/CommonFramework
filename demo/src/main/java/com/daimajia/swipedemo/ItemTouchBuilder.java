...
public class ItemTouchBuilder {
        ...
        return new ItemTouchHelper(new ItemTouchHelper.Callback() {
            ...
            public boolean onMove(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder target) {
                ...
                if (mDragCallback == null) {
                    ...
                    mDragWrapperAdapter.notifyItemMoved(viewHolder.getAdapterPosition(), target.getAdapterPosition());
                } else {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                if (mSwapCallback == null) {
                    ...
                    mDragWrapperAdapter.notifyItemRemoved(viewHolder.getAdapterPosition());
                } else {
    ...
    public class DragWrapperAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
